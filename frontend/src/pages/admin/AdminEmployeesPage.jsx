...
const roleCfg = {
  ...
  "sub-manager": "bg-primary-light text-primary",
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <input name="name" value={form.name} onChange={h} className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-blue-400" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input name="department" value={form.department} onChange={h} placeholder="e.g. Engineering" className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-blue-400" />
            </div>
            <div>
              <label className="text-xs font-semibold text-slate-500 mb-1.5 block">Designation</label>
              <input name="designation" value={form.designation} onChange={h} placeholder="e.g. Developer" className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-blue-400" />
            </div>
          </div>
        </div>
        <div className="flex gap-3 p-5 pt-0">
          ...
          <button onClick={submit} disabled={saving} className="flex-1 py-2.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover disabled:opacity-60">
  ...
  return (
    <DashboardLayout title="Employee Management">
      ...
      <div className="grid grid-cols-3 gap-4 mb-5">
        {[
          { label: "Total",    val: employees.length, color: "bg-primary-light border-blue-200 text-primary" },
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-blue-400"
          />
        </div>
