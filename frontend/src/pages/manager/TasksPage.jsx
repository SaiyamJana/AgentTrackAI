        ...
        <div className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select name="assignedTo" value={form.assignedTo} onChange={h}
...
export default function TasksPage() {
  ...
  // Only fetch tasks when a project is selected (backend requires projectId)
    ...
    <DashboardLayout title="Task Management">
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-3 page-enter-delay-3">
          ...
          ) : filtered.map(t => <TaskRow key={t._id} task={t} onDelete={deleteTask}/>)}
        </div>
      )}
