      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg">
        <div className="flex items-center justify-between p-5 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-primary-light rounded-xl flex items-center justify-center"><Icon name="plus" className="w-4 h-4 text-primary"/></div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select name="subManagerId" value={form.subManagerId} onChange={h}
                ...
                className="w-full border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-blue-400 disabled:opacity-50">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-blue-400 disabled:opacity-50"
              >
                <option value="">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-hover disabled:opacity-50 transition-colors shrink-0"
              >
                {adding ? "…" : "Add"}
              </button>
            </div>
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-2 shrink-0">
          ...
          <div className="w-20 h-1.5 bg-slate-100 rounded-full overflow-hidden">
            <div className={`h-full rounded-full ${task.status==="completed"?"bg-emerald-500":(task.completionPercentage??0)>50?"bg-primary-light0":"bg-amber-500"}`}
    ...
    <DashboardLayout title="Task Management">
      <div className="flex items-center justify-between mb-6 page-enter">
        ...
        <button onClick={() => setShowCreate(true)} disabled={projects.length===0}
          className="flex items-center gap-2 bg-primary text-white px-4 py-2.5 rounded-xl text-sm font-semibold hover:bg-primary-hover transition-colors shadow-sm shadow-blue-200 disabled:opacity-50 disabled:cursor-not-allowed">
